...
for i=1:length(imageDatasets)
    ...
    text((imageDatasets(i).yMinPos-minYPos)/imageDatasets(i).yVoxelSize+imageDatasets(i).yDim/2,...
        (imageDatasets(i).xMinPos-minXPos)/imageDatasets(i).xVoxelSize+imageDatasets(i).xDim/2,imageDatasets(i).DatasetName,'color','g');
